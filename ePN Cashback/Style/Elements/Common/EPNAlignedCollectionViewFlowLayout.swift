//
//  EPNAlignedCollectionViewFlowLayout.swift
//  ePN Cashback
//
//  Created by Александр Кузьмин on 11/06/2019.
...
open class EPNAlignedCollectionViewFlowLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: EPNAlignedCollectionViewFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: EPNAlignedCollectionViewFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: EPNAlignedCollectionViewFlowLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: EPNAlignedCollectionViewFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: EPNAlignedCollectionViewFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: EPNAlignedCollectionViewFlowLayout) {
