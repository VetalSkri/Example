...
class FavoriteShopsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        observer = NotificationCenter.default.addObserver(forName: .changedFavouriteStatusShop, object: nil, queue: .main, using: { [weak weakSelf = self] (notification) in
            print("changedFavouriteStatusShopInsideFavorite in ")
...
extension FavoriteShopsVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func setupContainer(inCollectionView collectionView: UICollectionView) {
        ...
        case .empty:
            ...
            textLabel.text = viewModel.getTextForEmptyFavouritePage
