...
class HowOrderPaymentsVC: UIViewController {
    ...
    private func setupView() {
        ...
        self.firstLabel.text = NSLocalizedString("FAQ_HowOrderPayments_main1", comment: "")
        
        self.secondLabel.font = .medium15
        self.secondLabel.textColor = .sydney
        self.secondLabel.text = NSLocalizedString("FAQ_HowOrderPayments_main2", comment: "")
        
        self.thirdLabel.font = .medium15
        self.thirdLabel.textColor = .sydney
        self.thirdLabel.text = NSLocalizedString("FAQ_HowOrderPayments_main3", comment: "")
    }
...
//
//        image1.image = UIImage(named: "illustration4.1")
//        image2.image = UIImage(named: "illustration4.2")
//        image3.image = UIImage(named: "illustration4.3")
//        image1.contentMode = .scaleAspectFit
//        image2.contentMode = .scaleAspectFit
//        image3.contentMode = .scaleAspectFit
//
//
//        mainTextTitle1.text = NSLocalizedString("FAQ_HowOrderPayments_main1", comment: "")
//        mainTextTitle2.text = NSLocalizedString("FAQ_HowOrderPayments_main2", comment: "")
//        mainTextTitle3.text = NSLocalizedString("FAQ_HowOrderPayments_main3", comment: "")
//
